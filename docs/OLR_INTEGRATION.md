...
| A text scorer (OLR has none) | Written spec + 31 test vectors, integer-only, no locale behaviour | [`TEXT_SCORER_SPEC.md`](TEXT_SCORER_SPEC.md), `tests/vectors/text_scorer.json` |
